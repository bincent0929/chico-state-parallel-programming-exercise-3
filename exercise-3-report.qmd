...
After LeftRiemann: my_rank=0, integrated area =      -0.0000000, step_size 0.001000, number quadratures=1800000
After Reduce: with n = 1800000 quadratures, our estimate
of the integral from 0.000000 to 1800.000000 =      -0.0000000
```

As you can see, we do get the `0.0` value that we are expecting. The only weird thing is that there's a minus sign in front of it. I'm not sure what's causing it.
...
After LeftRiemann: my_rank=0, integrated area =     135.5555556, step_size 0.001000, number quadratures=900000
After Reduce: with n = 900000 quadratures, our estimate
of the integral from 0.000000 to 900.000000 =     135.5555556
```

And according to our values in the spreadsheet, this is correct!
...
my_rank=0, a=0.00000000000000, b=1800.00000000000000, number of total steps=1800000
my_rank=0, start a=0.000000, end b=1800.000000, number of quadratures = 1800000, step_size=0.001000
After LeftRiemann: my_rank=0, integrated area =  122000.0000028, step_size 0.001000, number quadratures=1800000
After Reduce: with n = 1800000 quadratures, our estimate
of the integral from 0.000000 to 1800.000000 =  122000.0000028
```
