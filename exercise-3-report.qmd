...
I have 8 cores to be able to work on this, but due to the way this is set up, using 5 cores correctly divides the work across the cores to not cause remainder issues which results in incorrect calculations. It also isn't much faster because the amount of work isn't large enough to see a significant speed up with extra processes.
...
(.venv) vscode ➜ /workspaces/chico-state-parallel-programming-exercise-3/MPI_Examples (main) $ time mpiexec -n 8 ./train_problem_solutions
